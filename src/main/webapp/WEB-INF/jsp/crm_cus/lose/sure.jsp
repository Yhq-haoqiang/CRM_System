...
<div style="padding:5px;">
  ...
  <div class="operation_button">
    ...
    <a href="#" title="保存" onclick="sure();">确认流失</a>
  </div>
  <div class="out_bg">
    <div class="in_bg">
    <form action="<%=path %>/isloss" method="post" id="fm">
      <table border="0" cellpadding="0" cellspacing="0" class="table_input txt">
        ...
        <tr>
          <td>暂缓措施</td>
          <td colspan="3">${opp.reprieve }</td>
        </tr>
        <tr>
          <td valign="top">流失原因</td>
          <td><textarea rows="6" cols="36" name="whyloss" id="whyloss"/></textarea></td>
          <td></td>
          <td></td>
        </tr>
      </table>
...
<script type="text/javascript">
	function sure(){
		var whyloss = $("#whyloss").val().trim();
		if(whyloss == null || whyloss == ""){
			alert("流失原因不能为空！");
			return;
		}
		$("#fm").submit();
