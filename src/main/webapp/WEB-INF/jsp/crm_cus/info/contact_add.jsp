...
<div style="padding:5px;">
  ...
  <form action="<%=path %>/saverec" method="post" id="fm">
  <table border="0" cellpadding="0" cellspacing="0" class="table_show txt">
        <tr>
          ...
          <td width="200">${customer }<input type="hidden" value="${customer }" name="customer"></td>
        </tr>
  </table>
  <div class="out_bg">
    <div class="in_bg">
      <table border="0" cellpadding="0" cellspacing="0" class="table_input txt">
        <tr>
          <td width="126">时间</td>
          <td width="411"><input type="datetime" name="rdate" id="rdate"/></td>
          <td width="126">地点</td>
          <td width="442"><input type="text" name="address" id="address"/></td>
        </tr>
        <tr>
          <td>概要</td>
          <td><input type="text" name="outline" id="outline"/></td>
          <td>备注</td>
