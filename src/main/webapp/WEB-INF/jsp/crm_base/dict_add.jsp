...
<div style="padding:5px;">
  ...
  <div class="out_bg">
    <div class="in_bg">
    <form action="<%=path %>/addDict" method="post" id="form1">
      <table border="0" cellpadding="0" cellspacing="0" class="table_input txt">
        <tr>
          <td width="126">编号</td>
          <td width="411"><input type="text" disabled="disabled"/></td>
          <td width="126">类别</td>
          <td width="442"><input type="text" name="category" id="category"/></td>
        </tr>
        <tr>
          <td>条目</td>
          <td><input type="text" name="entry" id="entry"/></td>
          <td>值</td>
          <td><input type="text" name="values" id="valu"/></td>
        </tr>
        <tr>
          <td>是否可编辑</td>
          <td><input type="checkbox" id="checkbox" name="status" value="1"/></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
      </table>
